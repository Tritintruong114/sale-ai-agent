...
export function PaymentApprovalQueue({
  ...
  if (pending.length === 0) {
    ...
    return (
      <TopbarBannerSlot>
        ...
        >
          Không còn khoản nào cần bạn duyệt — agent đang tự gửi QR cho khách thanh toán.
        </DismissibleBanner>
      </TopbarBannerSlot>
    );
  }
  ...
  return (
    <TopbarBannerSlot>
      ...
      >
        <span className="font-semibold text-amber-900">{pending.length} khoản cần bạn duyệt</span>
